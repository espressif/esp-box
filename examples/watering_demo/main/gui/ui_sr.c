...
//         lv_obj_align(g_func_btn[i], LV_ALIGN_CENTER, i % 2 ? 48 : -48, i < 2 ? -48 + 5 : 48 + 5);
...
#else
#define FONT_CMD    lv_font_montserrat_36
#endif
...
void ui_sr_anim_init(void)
{
    ...
    lv_obj_set_style_text_font(g_sr_label, &FONT_CMD, LV_STATE_DEFAULT);
