 ...
 * as soon as possible.
 *
 * @param fp - Will be closed by the audio system when the playback has completed
 * @return
...
/**
 * @brief Initialize hardware, create and start audio task. Call before any other 'audio' functions.
 *
 * @param port - The i2s port for output
 * @return esp_err_t
 */
esp_err_t audio_player_init(i2s_port_t port,
